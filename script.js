...
const flashcardData = {
    ...
    chinese: [
        { word: '你好', translation: 'Halo', pronunciation: 'nǐ hǎo', example: '你好，你好吗？' },
        { word: '谢谢', translation: 'Terima kasih', pronunciation: 'xiè xiè', example: '非常感谢你' },
        { word: '好', translation: 'Bagus', pronunciation: 'hǎo', example: '这很好！' },
        { word: '是', translation: 'Ya', pronunciation: 'shì', example: '是的，我同意' },
        { word: '不', translation: 'Tidak', pronunciation: 'bù', example: '不，谢谢' },
        { word: '请', translation: 'Tolong', pronunciation: 'qǐng', example: '请帮我' },
        { word: '欢迎', translation: 'Selamat datang', pronunciation: 'huān yíng', example: '欢迎来到我家！' },
        { word: '再见', translation: 'Selamat tinggal', pronunciation: 'zài jiàn', example: '再见，回头见！' },
        { word: '对不起', translation: 'Maaf', pronunciation: 'duì bù qǐ', example: '对不起，我迟到了' },
        { word: '爱', translation: 'Cinta', pronunciation: 'ài', example: '我爱你！' }
    ],
    korean: [
        { word: '안녕하세요', translation: 'Halo', pronunciation: 'an-nyeong-ha-se-yo', example: '안녕하세요, 잘 지내세요?' },
        { word: '감사합니다', translation: 'Terima kasih', pronunciation: 'gam-sa-ham-ni-da', example: '정말 감사합니다!' },
        { word: '좋아요', translation: 'Bagus', pronunciation: 'jo-a-yo', example: '이건 좋아요!' },
        { word: '네', translation: 'Ya', pronunciation: 'ne', example: '네, 동의해요' },
        { word: '아니요', translation: 'Tidak', pronunciation: 'a-ni-yo', example: '아니요, 괜찮아요' },
        { word: '제발', translation: 'Tolong', pronunciation: 'je-bal', example: '제발 도와주세요' },
        { word: '환영합니다', translation: 'Selamat datang', pronunciation: 'hwan-yeong-ham-ni-da', example: '우리 집에 오신 것을 환영합니다!' },
        { word: '안녕히 가세요', translation: 'Selamat tinggal', pronunciation: 'an-nyeong-hi ga-se-yo', example: '안녕히 가세요, 또 만나요!' },
        { word: '미안합니다', translation: 'Maaf', pronunciation: 'mi-an-ham-ni-da', example: '늦어서 미안합니다' },
        { word: '사랑', translation: 'Cinta', pronunciation: 'sa-rang', example: '사랑해요!' }
    ]
};
...
const quizData = {
    ...
    chinese: [
        { question: 'Apa arti "你好"?', options: ['Selamat tinggal', 'Halo', 'Terima kasih', 'Maaf'], correct: 1 },
        { question: 'Terjemahkan "谢谢"', options: ['Halo', 'Tolong', 'Terima kasih', 'Ya'], correct: 2 },
        { question: 'Apa arti "好"?', options: ['Jelek', 'Bagus', 'Besar', 'Kecil'], correct: 1 },
        { question: 'Pilih arti "是"', options: ['Tidak', 'Mungkin', 'Ya', 'Tolong'], correct: 2 },
        { question: 'Apa arti "不"?', options: ['Ya', 'Tidak', 'Tolong', 'Bagus'], correct: 1 },
        { question: 'Terjemahkan "请"', options: ['Maaf', 'Terima kasih', 'Tolong', 'Halo'], correct: 2 },
        { question: 'Apa arti "欢迎"?', options: ['Selamat tinggal', 'Selamat datang', 'Halo', 'Terima kasih'], correct: 1 },
        { question: 'Pilih arti "再见"', options: ['Halo', 'Tolong', 'Selamat tinggal', 'Maaf'], correct: 2 },
        { question: 'Apa arti "对不起"?', options: ['Terima kasih', 'Maaf', 'Tolong', 'Ya'], correct: 1 },
        { question: 'Terjemahkan "爱"', options: ['Benci', 'Suka', 'Cinta', 'Teman'], correct: 2 }
    ],
    korean: [
        { question: 'Apa arti "안녕하세요"?', options: ['Selamat tinggal', 'Halo', 'Terima kasih', 'Maaf'], correct: 1 },
        { question: 'Terjemahkan "감사합니다"', options: ['Halo', 'Tolong', 'Terima kasih', 'Selamat tinggal'], correct: 2 },
        { question: 'Apa arti "좋아요"?', options: ['Jelek', 'Bagus', 'Besar', 'Kecil'], correct: 1 },
        { question: 'Pilih arti "네"', options: ['Tidak', 'Mungkin', 'Ya', 'Tolong'], correct: 2 },
        { question: 'Apa arti "아니요"?', options: ['Ya', 'Tidak', 'Tolong', 'Maaf'], correct: 1 },
        { question: 'Terjemahkan "제발"', options: ['Maaf', 'Terima kasih', 'Tolong', 'Halo'], correct: 2 },
        { question: 'Apa arti "환영합니다"?', options: ['Selamat tinggal', 'Selamat datang', 'Halo', 'Terima kasih'], correct: 1 },
        { question: 'Pilih arti "안녕히 가세요"', options: ['Halo', 'Tolong', 'Selamat tinggal', 'Maaf'], correct: 2 },
        { question: 'Apa arti "미안합니다"?', options: ['Terima kasih', 'Maaf', 'Tolong', 'Ya'], correct: 1 },
        { question: 'Terjemahkan "사랑"', options: ['Benci', 'Suka', 'Cinta', 'Teman'], correct: 2 }
    ]
};
...
function updateFlashcard() {
    const cards = flashcardData[state.selectedLanguage];
    if (!cards) return;
    ...
    document.getElementById('learned-btn-text').textContent = `Sudah Paham (+10pts)`;
    
    const levelName = getLevelNameByLanguage(state.selectedLanguage);
    document.getElementById('flashcard-level-badge').textContent = levelName;
    document.getElementById('flashcard-level-badge').className = 'level-badge level-1';
...
function markAsLearned() {
    if (!state.learnedCards.includes(state.currentCard)) {
        ...
        const cards = flashcardData[state.selectedLanguage];
        if (state.learnedCards.length >= cards.length) {
            setTimeout(() => {
                const nextLang = getNextLanguage(state.selectedLanguage);
                if (nextLang) {
                    alert(`🎉 SELAMAT! Anda telah menyelesaikan ${getLanguageName(state.selectedLanguage)}!\n\n✨ Sekarang mari belajar ${getLanguageName(nextLang)}! 🚀`);
                    ...
                    alert(`🏆 LUAR BIASA! Anda telah menyelesaikan semua bahasa! 🎊\n\nAnda adalah Master Bahasa! 👑`);
                }
            }, 500);
        }
    }
...
function updateProgress() {
    ...
    document.getElementById('progress-level').textContent = getLanguageName(state.selectedLanguage);
...
function getLevelNameByLanguage(langId) {
    const names = {
    ...
    return names[langId] || 'Basic Level';
}
...
function getNextLanguage(currentLang) {
    ...
    const currentIndex = langIds.indexOf(currentLang);
    if (currentIndex < langIds.length - 1) {
        return langIds[currentIndex + 1];
    }
    return null;
}
...
function renderQuestion() {
    const questions = quizData[state.selectedLanguage];
    ...
    const levelName = getLevelNameByLanguage(state.selectedLanguage);
    document.getElementById('quiz-level-badge-game').textContent = levelName;
    document.getElementById('quiz-level-badge-game').className = 'level-badge level-1';
...
function showQuizResult() {
    ...
    // Auto level up = pindah ke bahasa berikutnya jika score >= 60%
    if (shouldLevelUp) {
        setTimeout(() => {
            const nextLang = getNextLanguage(state.selectedLanguage);
            if (nextLang) {
                const confetti = `
🎊 SELAMAT! KUIS ${getLanguageName(state.selectedLanguage).toUpperCase()} SELESAI! 🎊

✨ Anda telah menguasai ${getLanguageName(state.selectedLanguage)}!

🚀 Mari lanjut ke ${getLanguageName(nextLang)}!
                `;
                alert(confetti);
                state.selectedLanguage = nextLang;
                renderLanguageGrid();
            } else {
                alert(`🏆 AMAZING! Anda telah menyelesaikan SEMUA KUIS! 🎊\n\nAnda adalah Language Master! 👑`);
            }
        }, 1000);
    }
}
...
function resetQuiz() {
    ...
    const levelName = getLevelNameByLanguage(state.selectedLanguage);
    document.getElementById('quiz-level-badge').textContent = levelName;
    document.getElementById('quiz-level-badge').className = 'level-badge level-1';
    document.getElementById('quiz-start-level').textContent = '';
}
...
function endGame() {
    ...
    const requiredScore = 7; // Perlu 7 dari 10 untuk pindah bahasa berikutnya
    let message = `🎮 GAME SELESAI! 🎮\n\nSkor Anda: ${state.gameScore}\n\n`;
    
    if (state.gameScore >= requiredScore) {
        const nextLang = getNextLanguage(state.selectedLanguage);
        if (nextLang) {
            message += `🎉 HEBAT! Anda lulus ${getLanguageName(state.selectedLanguage)}! 🚀\n\n`;
            message += `✨ Mari lanjut ke ${getLanguageName(nextLang)}! 🌟`;
            alert(message);
            state.selectedLanguage = nextLang;
            renderLanguageGrid();
        } else {
            message += '🏆 AMAZING! Anda sudah menyelesaikan SEMUA bahasa! 👑';
            alert(message);
        }
    } else if (state.gameScore >= 5) {
        message += '💪 BAGUS! Terus berlatih untuk lulus! 🔥';
        alert(message);
    } else {
...
function backToGameSelection() {
    ...
    const levelName = getLevelNameByLanguage(state.selectedLanguage);
    document.getElementById('game-level-badge').textContent = levelName;
    document.getElementById('game-level-badge').className = 'level-badge level-1';
}
